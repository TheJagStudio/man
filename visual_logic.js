 ...
 * Thu Sep 16 2021 20:23:45 GMT+0530 (India Standard Time)
...
operateAnimation('STOP', 'Armature', null, null, 'AUTO', 1,
  ...
  registerOnClick('Sphere', false, false, [0,1,2], function() {

    operateAnimation('PAUSE', 'Armature', null, null, 'AUTO', 1,
            function() {}, undefined, false);


    operateAnimation('PLAY', 'Armature', null, null, 'LoopOnce', 1,
            function() {}, undefined, false);

        setObjTransform('Sphere', 'position', 3, -2.5, -0.1, false);
    registerSetTimeout(0.5, function() {
      setObjTransform('Sphere', 'position', 3, -2.5, 0, false);
    });
  }, function() {});
});
